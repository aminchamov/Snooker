...
private fun Player.toRemoteJson(): JSONObject = JSONObject()
    .put("id", id)
    .put("name", name)
    .putNullable("image_uri", imageUri)
...
private fun Tournament.toRemoteJson(): JSONObject = JSONObject()
    ...
    .put("name", name)
    .put("status", status)
    .putNullable("champion_player_id", championPlayerId)
...
private fun TournamentMatch.toRemoteJson(): JSONObject = JSONObject()
    ...
    .putNullable("player1_id", player1Id)
    .putNullable("player2_id", player2Id)
    .putNullable("winner_player_id", winnerPlayerId)
    .putNullable("linked_match_id", linkedMatchId)
    .put("state", state)
    .put("source_created_at_ms", createdAt)
    .put("source_updated_at_ms", updatedAt)
    .put("deleted_at", JSONObject.NULL)
...
private fun Match.toRemoteJson(): JSONObject = JSONObject()
    ...
    .putNullable("ended_at_ms", endedAt)
    ...
    .putNullable("break_history_summary", breakHistorySummary)
    .put("match_type", matchType)
    .putNullable("tournament_id", tournamentId)
    .putNullable("tournament_round", tournamentRound)
...
private fun LiveMatchSnapshot.toRemoteJson(): JSONObject = JSONObject()
    ...
    .putNullable("player1_id", player1Id)
    .putNullable("player2_id", player2Id)
    .putNullable("player1_name", player1Name)
    .putNullable("player2_name", player2Name)
    .put("player1_score", player1Score)
    .put("player2_score", player2Score)
    .putNullable("active_player_number", activePlayerNumber)
    ...
    .putNullable("tournament_id", tournamentId)
    .putNullable("tournament_round", tournamentRound)
    .putNullable("tournament_match_id", tournamentMatchId)
    .put("source_updated_at_ms", updatedAt)
    .put("deleted_at", JSONObject.NULL)
